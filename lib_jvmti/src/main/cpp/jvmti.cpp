...
static jmethodID g_onMethodEnterMethod = nullptr;
static jmethodID g_onMethodExitMethod = nullptr;
static jmethodID g_onVariableChangedMethod = nullptr;
...
static bool ensureDebugStackMotionClass(JNIEnv* env) {
    if (g_debugStackMotionClass != nullptr &&
        g_onMethodEnterMethod != nullptr &&
        g_onMethodExitMethod != nullptr &&
        g_onVariableChangedMethod != nullptr) {
        return true;
    }
    jclass localClass = env->FindClass("com/newcharbase/jvmti/DebugStackMotion");
    ...
    g_onMethodEnterMethod = env->GetStaticMethodID(g_debugStackMotionClass,
            "onMethodEnter", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    g_onMethodExitMethod = env->GetStaticMethodID(g_debugStackMotionClass,
            "onMethodExit", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    g_onVariableChangedMethod = env->GetStaticMethodID(g_debugStackMotionClass,
            "onVariableChanged", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V");
    if (g_onMethodEnterMethod == nullptr || g_onMethodExitMethod == nullptr || g_onVariableChangedMethod == nullptr) {
...
static void dispatchEvent(JNIEnv* env, const MethodEvent& event) {
    ...
    jmethodID target = event.isEntry ? g_onMethodEnterMethod : g_onMethodExitMethod;
    env->CallStaticVoidMethod(g_debugStackMotionClass, target, className, methodName, methodDesc);
...
void JNICALL onFieldModification(jvmtiEnv* jvmti, JNIEnv* env, jthread /*thread*/, jmethodID method,
    ...
    if (ensureDebugStackMotionClass(env)) {
        ...
        env->CallStaticVoidMethod(g_debugStackMotionClass, g_onVariableChangedMethod,
                                  classNameStr, methodNameStr, methodDescStr, fieldNameStr, valueObj);
...
Java_com_newcharbase_jvmti_DebugStackMotion_registerMethodNative(JNIEnv* env, jclass /*clazz*/,
...
extern "C" JNIEXPORT void JNICALL
Java_com_newcharbase_jvmti_DebugStackMotion_clearRegisteredMethodsNative(JNIEnv* env, jclass /*clazz*/) {
    releaseInterestedMethods(env);
}

extern "C" JNIEXPORT void JNICALL
Java_com_newcharbase_jvmti_DebugStackMotionAgent_startAgentNative(JNIEnv* /*env*/, jclass /*clazz*/) {
    LOGI("startAgentNative called");
}

extern "C" JNIEXPORT void JNICALL
Java_com_newcharbase_jvmti_DebugStackMotionAgent_stopAgentNative(JNIEnv* /*env*/, jclass /*clazz*/) {
    LOGI("stopAgentNative called");
}

extern "C" JNIEXPORT void JNICALL
Java_com_newcharbase_jvmti_DebugStackMotion_releaseNative(JNIEnv* env, jclass /*clazz*/) {
